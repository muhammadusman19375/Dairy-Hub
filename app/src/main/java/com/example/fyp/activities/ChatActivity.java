...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageToShare = getIntent().getStringExtra("message");
        senderUid = FirebaseAuth.getInstance().getUid();

        Log.d("TAG", "onCreate: "+messageToShare);
        if (messageToShare!=null){
            binding.messageBox.setText(messageToShare);
//            sendMessage();
        }
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    public void sendMessage(){
        ...
        Log.d("TAG", "sendMessage: "+senderRoom);
        Log.d("TAG", "sendMessage: "+receiverRoom);
        if (!messageTxt.equals("")){
            Log.d("TAG", "sendMessage: "+messageTxt);
            binding.messageBox.setText("");
            Date date = new Date();
            Message message = new Message(messageTxt, senderUid, date.getTime());
